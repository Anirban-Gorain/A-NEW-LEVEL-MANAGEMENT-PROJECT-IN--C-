...
int _menu(void){
    ...
    if ((_serial_Number  <= _highest_Serial_Number_Of_The_Menu && _serial_Number > 0) || (*_choice_Of_The_User == 68 || *_choice_Of_The_User == 100) || (*_choice_Of_The_User == 65 || *_choice_Of_The_User == 97))
    {
        ...
        else if(*_choice_Of_The_User == 65 || *_choice_Of_The_User == 97)
        {
            ...
            _highest_Serial_Number_Of_The_Menu++;
            _add_More_Option(_highest_Serial_Number_Of_The_Menu);
...
void _add_More_Option(int _highest_Serial_Number_Of_The_Menu){
    ...
    fprintf(_address_Of_The_Menu_Dot_Txt, "\n%d)%s.", _highest_Serial_Number_Of_The_Menu, _which_Menu_Will_Creat_By_The_User);
    fclose(_address_Of_The_Menu_Dot_Txt);
...
void _serial_Number_Fixer(void){
    ...
    char _store_Menu_And_Path_For_Operations[150];
    int _ignore_Section;
    ...
    // Ignoring the first line in MENU.txt.
    ...
    while (!feof(_address_Of_The_Menu_Dot_Txt))
    {
        ...
        for (_ignore_Section = 1; *(_store_Menu_And_Path_For_Operations + _ignore_Section) != ')'; _ignore_Section++);
        _ignore_Section++;

        fprintf(_address_Of_Temporary_File_One, "\n%d)%s", _serial_Number, _store_Menu_And_Path_For_Operations + _ignore_Section);
        _serial_Number++;
    }
    ...
    // Ignoring the first line in PATH.txt.
